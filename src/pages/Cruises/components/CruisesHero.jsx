...
import HeroImg from "@/assets/cruises/hero.png";
  ...
  return (
    <div className="w-full h-[80vh] bg-gradient-to-br from-sky-50 via-blue-50 to-sky-100 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        >
          <Ship className="w-8 h-8 text-sky-400 opacity-60" />
        </motion.div>
        ...
        >
          <Anchor className="w-6 h-6 text-blue-400 opacity-40" />
        </motion.div>
        ...
        >
          <Waves className="w-12 h-12 text-sky-500 opacity-70" />
        </motion.div>
        ...
        >
          <Compass className="w-10 h-10 text-blue-500 opacity-60" />
        </motion.div>
        ...
        >
          <Ship className="w-14 h-14 text-blue-400 opacity-50" />
        </motion.div>

        {/* Decorative Dots - Ocean Bubbles */}
        <motion.div 
      ...
      <div className="relative z-10 h-full grid grid-cols-1 lg:grid-cols-2">
        ...
        <div className="flex items-center justify-center px-6 sm:px-12 lg:px-16 py-12 lg:py-0">
          ...
          >
            ...
            >
              ...
              <br />
              <span className="text-sky-600">Cruise</span>
            </motion.h1>
            ...
            >
              Find the best cruise deals with trusted cruise lines and instant booking.
            </motion.p>
        ...
        {/* Right Content - Cruise Image with Overlay Elements */}
        <div className="relative h-64 lg:h-full">
          ...
          >
            <div className="flex items-center space-x-2">
              ...
              <div>
                <div className="text-sm font-bold text-gray-800">Ocean View</div>
          ...
          >
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xs font-medium text-gray-700">Pool Deck</span>
            </div>
          </motion.div>
          ...
          >
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xs font-medium text-gray-700">Fine Dining</span>
            </div>
          </motion.div>
          ...
          >
            <div className="text-center">
              <div className="text-lg font-bold">From $399</div>
              <div className="text-xs opacity-90">7 nights</div>
            </div>
          </motion.div>
        </div>
      </div>

      {/* Floating Cruise Amenity Icons */}
      <div className="absolute inset-0 pointer-events-none">
        ...
        >
          <Waves className="w-8 h-8 text-sky-400 opacity-50" />
        </motion.div>
      </div>
    </div>
  );

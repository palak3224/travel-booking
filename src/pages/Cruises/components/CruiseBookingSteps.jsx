...
const CruiseBookingSteps = () => {
  const steps = [
    {
      number: 1,
      title: "Search",
      subtitle: "your dream cruise",
      description: "Enter your departure port, select cruise dates, and choose the number of passengers and cabin preferences.",
      icon: Search,
      color: "sky",
      delay: 0.2
    },
    {
      number: 2,
      title: "Compare",
      subtitle: "cruise options",
      description: "Browse through hundreds of cruise lines with real-time prices, itineraries, ship amenities, and passenger reviews.",
      icon: GitCompare,
      color: "blue",
      delay: 0.4
    },
    {
      ...
      title: "Book",
      subtitle: "& set sail",
      description: "Complete your secure payment and receive instant booking confirmation. Get ready for the adventure of a lifetime!",
      icon: CreditCard,
      color: "sky",
      delay: 0.6
    }
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-600 text-lg md:text-xl max-w-2xl mx-auto">
            Book your perfect cruise in just 3 simple steps
          </p>
        </motion.div>

        {/* Cruise Journey Visualization */}
        <div className="relative mb-20">
          {/* Journey Path Background - Ocean Wave */}
          ...
          <motion.div
            ...
            initial={{ x: -200, scale: 0.8, rotate: -5 }}
            animate={{ x: 200, scale: 1, rotate: 5 }}
            transition={{ 
              duration: 10, 
              repeat: Infinity, 
              repeatType: "reverse",
          ...
          <div className="flex justify-between items-center max-w-4xl mx-auto">
            ...
            >
              ...
              <span className="text-sm text-gray-600 mt-1">Adventure</span>
            </motion.div>
          </div>
        </div>
                      ...
                      <div className="mt-6">
                        <div className="bg-blue-50 rounded-xl p-4">
                          <div className="flex items-center justify-between text-sm">
                            <span className="text-blue-700 font-medium">500+ Cruises</span>
                            <span className="text-blue-700 font-medium">Best Deals</span>
                          </div>
                      ...
                      <div className="mt-6">
                        <div className="bg-sky-50 rounded-xl p-4 flex items-center justify-center">
                          <div className="flex items-center space-x-2">
                            ...
                            <span className="text-sky-700 font-medium text-sm">Ready to Sail</span>
                          </div>
                        </div>
                      </div>
                    )}
        ...
        >
          ...
          <p className="text-gray-500 text-sm mt-4">
            Join millions of satisfied cruisers
          </p>
        </motion.div>

        {/* Floating Cruise Elements */}
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          ...
          >
            <div className="w-8 h-8 bg-blue-300 rounded-full opacity-30 flex items-center justify-center">
...
export default CruiseBookingSteps;